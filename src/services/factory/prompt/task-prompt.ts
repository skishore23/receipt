...
const renderTaskPromptBody = (input: {
  ...
  return [
    ...
    `The runtime will finalize an evidence bundle sidecar for every task, including command provenance, stdout/stderr digests, timestamps, and raw-log pointers, even if the job ends blocked, failed, or canceled.`,
