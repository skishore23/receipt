...
const FACTORY_CHAT_LOOP_TEMPLATE = [
  ...
  "- format `action.text` as clean markdown when structure helps: use `##` headings, one bullet or numbered item per line, and markdown tables for repeated rows with shared columns",
